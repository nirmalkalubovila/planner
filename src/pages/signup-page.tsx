    ...
    const handleGoogleSignup = async () => {
        try {
            const { error } = await supabase.auth.signInWithOAuth({
                provider: 'google',
                options: {
                    redirectTo: `${window.location.origin}/personalize`,
                }
            });
                ...
                <Card className="w-full max-w-md text-center py-8">
                    <CardHeader>
                        ...
                        <CardDescription className="text-base mt-2">
                            We've sent a confirmation link to <strong>{email}</strong>. Please click it to verify your account and log in.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Link to="/login">
        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <Card className="w-full max-w-md">
                <CardHeader className="space-y-1 text-center">
                    ...
                    <CardDescription>
                        Sign up below to start tracking your goals and habits.
                    </CardDescription>
                </CardHeader>
