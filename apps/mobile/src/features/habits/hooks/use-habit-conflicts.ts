...
import { timeToMinutes, minutesToTime, isTimeOverlapping, isSleepOverlapping, type Habit } from '@llb/core';
...
/** Port of apps/web/src/features/habits/hooks/use-habit-conflicts.ts — same
 * pure conflict logic, only the auth/profile hook imports are mobile's own. */
