...
import { useUserProfile , useGetHabits } from '@llb/api';
import { WeekUtils , GridState, Habit , DAYS_OF_WEEK, SLOTS_PER_DAY , timeToMinutes, minutesToTime } from '@llb/core';
...
/** Port of apps/web/src/features/planner/hooks/use-planner-grid.ts — pure
 * derivation logic, no DOM dependency, ports unchanged. */
