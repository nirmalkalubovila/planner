// The stage data and pure progress math now live in @llb/core (platform-
// agnostic, no localStorage). Only the browser-storage-backed "has this
// milestone been celebrated yet" tracking stays here.
export {
  type MilestoneStage,
...
import { computeMilestoneProgress, type MilestoneStage } from '@llb/core';
